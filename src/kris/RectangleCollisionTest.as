package kris {
	...
	public class RectangleCollisionTest extends TestCase {
		...
		// detect
		public function test_detect_should_throw_error_when_both_arguments_are_the_same_object():void {
			var callOn:Rectangle = new Rectangle(0, 0, 0, 0);
			assertThrowsError(RectangleCollision.detect, callOn, callOn);
		}

		public function test_calling_detect_on_intersecting_rectangles_should_return_true():void {
		...
		public function test_calling_detect_on_rectangles_with_a_touching_side_should_return_false():void {
		...
		// resolve
		public function test_calling_resolve_should_throw_error_when_both_arguments_are_the_same_object():void {
			var reactionary:Rectangle = newRectangle(0, 0, 0, 0);
			assertThrowsError(RectangleCollision.resolve, reactionary, reactionary);
		}

		public function test_calling_reslove_on_not_colliding_rectangles_returns_reactionary():void {
		...
		public function test_should_reslove_to_left_correctly_1():void {
		...
		public function test_should_reslove_to_left_correctly_2():void {
			var reactionary:Rectangle = new Rectangle(2, -1, 100, 100);
			var stationary:Rectangle = new Rectangle(100, 0, 100, 100);
			var result:Rectangle = RectangleCollision.resolve(reactionary, stationary);
			assertPosition(reactionary, 2, -1);
		...
		public function test_should_reslove_to_right_correctly_1():void {
		...
		public function test_should_reslove_to_right_correctly_2():void {
			var reactionary:Rectangle = new Rectangle(98, -1, 100, 100);
			var stationary:Rectangle = new Rectangle(0, 0, 100, 100);
			var result:Rectangle = RectangleCollision.resolve(reactionary, stationary);
			assertPosition(reactionary, 98, -1);
		...
		public function test_should_reslove_to_top_correctly_1():void {
		...
		public function test_should_reslove_to_top_correctly_2():void {
			var reactionary:Rectangle = new Rectangle(-1, 2, 100, 100);
			var stationary:Rectangle = new Rectangle(0, 100, 100, 100);
			var result:Rectangle = RectangleCollision.resolve(reactionary, stationary);
			assertPosition(reactionary, -1, 2);
		...
		public function test_should_reslove_to_bottom_correctly_1():void {
		...
		public function test_should_reslove_to_bottom_correctly_2():void {
			var reactionary:Rectangle = new Rectangle(-1, 98, 100, 100);
			var stationary:Rectangle = new Rectangle(0, 0, 100, 100);
			var result:Rectangle = RectangleCollision.resolve(reactionary, stationary);
			assertPosition(reactionary, -1, 98);
